        ...
        <div class="card">
            ...
            <form method="POST" action="/students/update/{{$user->id}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="fullname" type="text" class="form-control @error('fullname') is-invalid @enderror" name="fullname" value="{{$user->fullname}}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="phonenumber" type="text" class="form-control @error('phonenumber') is-invalid @enderror" name="phonenumber" value="{{$user->phonenumber}}" required>
